...
<template>
  ...
  <div>
    <main>
      ...
      <p class="description">
        Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://hr-ja.sentry.io/issues/?project=4510424329617408">Issues Page</a>.
